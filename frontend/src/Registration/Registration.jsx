...
const Registration = () => {
  ...
  // Function to validate CNIC input (only digits, exactly 13 characters)
  ...
  //     })
  //     .then((res) => {
  //       alert(`User created successfully. Employee ID: ${res.data._id}`);
  //     })
  //     .catch((err) => {
  //       console.error("Error registering user:", err);
  //       if (err.response && err.response.data) {
  //         alert(err.response.data.error); // Show specific error message from server
  //       } else {
    ...
    <div className="registration-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-row">
          ...
          <div className="inputBox">{/* Last Name Validation - only alphabets */}
            <input
              type="text"
              value={lname}
          ...
          {/* CNIC Validation - exactly 13 digits, no alphabets */}
          <div className="inputBox">
            <input
              type="text"
              value={cnic}
            ...
            <p
              style={{
                ...
                fontSize: "12px",
                marginTop: "5px",
                visibility: cnic.length === 13 ? "hidden" : "visible"
              }}
            >
          ...
          <div className="inputBox">
            ...
            <p
              style={{
                ...
                fontSize: "12px",
                marginTop: "5px",
                visibility: phoneNum.length === 11 ? "hidden" : "visible"
              }}
            >
        ...
        <div className="form-row-company">
          <div>
            <select
              value={department}
              onChange={handleDepartmentChange} // Use handleDepartmentChange here
            >
